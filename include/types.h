...
enum Castling_Rights : std::uint8_t {
    ...
    BLACK_CASTLING_00 = 0b0100,
    BLACK_CASTLING_000 = 0b1000,

    WHITE_CASTLING = WHITE_CASTLING_00 | WHITE_CASTLING_000,
    BLACK_CASTLING = BLACK_CASTLING_00 | BLACK_CASTLING_000,
    KING_SIDE = WHITE_CASTLING_00 | BLACK_CASTLING_00,
    QUEEN_SIDE = WHITE_CASTLING_000 | BLACK_CASTLING_000,
